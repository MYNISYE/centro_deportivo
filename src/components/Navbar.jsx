...
const Navbar = (props) => {
  ...
  return (
    <div className='navbar navbar-expand-lg navbar-light bg-danger py-4 fixed shadow-lg p-3 mb-5'>
      {props.firebaseUser !== null ? (<Link className='navbar-brand text-bg-primary ' to="/">Unicosta - {props.firebaseUser.email} </Link>) : <Link className='navbar-brand text-bg-primary' to="/">Unicosta </Link>}
